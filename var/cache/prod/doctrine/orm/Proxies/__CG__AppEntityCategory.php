...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'category_name', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'category'];
        }
     ...
     * {@inheritDoc}
     */
    public function addCategory(\App\Entity\CategoriesAndBooks $category): \App\Entity\Category
    {
     ...
     * {@inheritDoc}
     */
    public function removeCategory(\App\Entity\CategoriesAndBooks $category): \App\Entity\Category
    {
