...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\Main\\BaseController' => 'getBaseControllerService',
            'App\\Controller\\Main\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\Manager\\ManagerActionsController' => 'getManagerActionsControllerService',
            'App\\Controller\\Manager\\ManagerBaseController' => 'getManagerBaseControllerService',
            'App\\Controller\\Manager\\ManagerHomeController' => 'getManagerHomeControllerService',
    ...
    {
        $this->services['App\\Controller\\Admin\\AdminBaseController'] = $instance = new \App\Controller\Admin\AdminBaseController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\Admin\\AdminBaseController', $this));
    ...
    {
        $this->services['App\\Controller\\Admin\\AdminHomeController'] = $instance = new \App\Controller\Admin\AdminHomeController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\Admin\\AdminHomeController', $this));
    ...
    protected function getAdminUserControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\Admin\\AdminUserController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Main\BaseController' shared autowired service.
     *
     * @return \App\Controller\Main\BaseController
     */
    protected function getBaseControllerService()
    {
        $this->services['App\\Controller\\Main\\BaseController'] = $instance = new \App\Controller\Main\BaseController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\Main\\BaseController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Main\HomeController' shared autowired service.
     *
     * @return \App\Controller\Main\HomeController
     */
    protected function getHomeControllerService()
    {
        $this->services['App\\Controller\\Main\\HomeController'] = $instance = new \App\Controller\Main\HomeController(($this->services['doctrine'] ?? $this->getDoctrineService()));

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\Main\\HomeController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Manager\ManagerActionsController' shared autowired service.
     *
     * @return \App\Controller\Manager\ManagerActionsController
     */
    protected function getManagerActionsControllerService()
    {
        $this->services['App\\Controller\\Manager\\ManagerActionsController'] = $instance = new \App\Controller\Manager\ManagerActionsController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\Manager\\ManagerActionsController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Manager\ManagerBaseController' shared autowired service.
     *
     * @return \App\Controller\Manager\ManagerBaseController
     */
    protected function getManagerBaseControllerService()
    {
        $this->services['App\\Controller\\Manager\\ManagerBaseController'] = $instance = new \App\Controller\Manager\ManagerBaseController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\Manager\\ManagerBaseController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Manager\ManagerHomeController' shared autowired service.
     *
     * @return \App\Controller\Manager\ManagerHomeController
     */
    protected function getManagerHomeControllerService()
    {
        $this->services['App\\Controller\\Manager\\ManagerHomeController'] = $instance = new \App\Controller\Manager\ManagerHomeController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\Manager\\ManagerHomeController', $this));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('GGYwlnWJrK', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xyaiPC7KMP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => 'C:\\Books-repos\\src\\Entity']), 'App\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\CategoriesAndBooksRepository' => ['privates', 'App\\Repository\\CategoriesAndBooksRepository', 'getCategoriesAndBooksRepositoryService', false],
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $b = new \Symfony\Component\HttpKernel\Config\FileLocator(($this->services['kernel'] ?? $this->get('kernel', 1)), 'C:\\Books-repos\\src/Resources', [0 => 'C:\\Books-repos\\src'], false);
    ...
    {
        $a = new \Symfony\Bundle\TwigBundle\Loader\NativeFilesystemLoader([], 'C:\\Books-repos');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\framework-bundle/Resources/views', 'Framework');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\framework-bundle/Resources/views', '!Framework');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\twig-bundle/Resources/views', 'Twig');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\twig-bundle/Resources/views', '!Twig');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('C:\\Books-repos\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('C:\\Books-repos\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/templates', 'KnpPaginator');
        $a->addPath('C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/templates', '!KnpPaginator');
        $a->addPath('C:\\Books-repos/templates');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('C:\\Books-repos\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($e, 'C:\\Books-repos', 'UTF-8'));
    ...
    {
        return $this->services['web_profiler.controller.profiler'] = new \Symfony\Bundle\WebProfilerBundle\Controller\ProfilerController(($this->services['router'] ?? $this->getRouterService()), ($this->services['profiler'] ?? $this->getProfilerService()), ($this->services['twig'] ?? $this->getTwigService()), $this->parameters['data_collector.templates'], ($this->privates['web_profiler.csp.handler'] ?? $this->getWebProfiler_Csp_HandlerService()), 'C:\\Books-repos');
    }
    ...
    /**
     * Gets the private '.service_locator.KdFv2Aw' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_KdFv2AwService()
    {
        return $this->privates['.service_locator.KdFv2Aw'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\Admin\\AdminUserController::create' => ['privates', '.service_locator.ccM2MGC', 'get_ServiceLocator_CcM2MGCService', false],
            'App\\Controller\\Main\\HomeController::index' => ['privates', '.service_locator.n8gOTNr', 'get_ServiceLocator_N8gOTNrService', false],
            'App\\Controller\\SecurityController::login' => ['privates', '.service_locator.g.xob4v', 'get_ServiceLocator_G_Xob4vService', false],
            'App\\Controller\\Admin\\AdminUserController:create' => ['privates', '.service_locator.ccM2MGC', 'get_ServiceLocator_CcM2MGCService', false],
            'App\\Controller\\Main\\HomeController:index' => ['privates', '.service_locator.n8gOTNr', 'get_ServiceLocator_N8gOTNrService', false],
            'App\\Controller\\SecurityController:login' => ['privates', '.service_locator.g.xob4v', 'get_ServiceLocator_G_Xob4vService', false],
        ], [
            'App\\Controller\\Admin\\AdminUserController::create' => '?',
            'App\\Controller\\Main\\HomeController::index' => '?',
    ...
    /**
     * Gets the private 'App\Repository\CategoriesAndBooksRepository' shared autowired service.
     *
     * @return \App\Repository\CategoriesAndBooksRepository
     */
    protected function getCategoriesAndBooksRepositoryService()
    {
        return $this->privates['App\\Repository\\CategoriesAndBooksRepository'] = new \App\Repository\CategoriesAndBooksRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lRCsbKwatL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('R-Sbd-KGww', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7a1xKRRDtC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UWvsVYKIGz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xshHBwexyp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $this->privates['console.command.assets_install'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\AssetsInstallCommand(($this->services['filesystem'] ?? ($this->services['filesystem'] = new \Symfony\Component\Filesystem\Filesystem())), 'C:\\Books-repos');
    ...
    {
        $this->privates['console.command.form_debug'] = $instance = new \Symfony\Component\Form\Command\DebugCommand(($this->privates['form.registry'] ?? $this->getForm_RegistryService()), [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type', 1 => 'App\\Form', 2 => 'Symfony\\Bridge\\Doctrine\\Form\\Type'], [0 => 'App\\Form\\BooksType', 1 => 'App\\Form\\CategoryType', 2 => 'App\\Form\\UserType', 3 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType', 4 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType', 5 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType', 6 => 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType'], [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TransformationFailureExtension', 1 => 'Symfony\\Component\\Form\\Extension\\HttpFoundation\\Type\\FormTypeHttpFoundationExtension', 2 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\FormTypeValidatorExtension', 3 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\RepeatedTypeValidatorExtension', 4 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\SubmitTypeValidatorExtension', 5 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\UploadValidatorExtension', 6 => 'Symfony\\Component\\Form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension', 7 => 'Symfony\\Component\\Form\\Extension\\DataCollector\\Type\\DataCollectorTypeExtension'], [0 => 'Symfony\\Component\\Form\\Extension\\Validator\\ValidatorTypeGuesser', 1 => 'Symfony\\Bridge\\Doctrine\\Form\\DoctrineOrmTypeGuesser'], ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()));
    ...
    {
        $this->privates['console.command.secrets_decrypt_to_local'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsDecryptToLocalCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\Books-repos/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\Books-repos/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_encrypt_from_local'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsEncryptFromLocalCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\Books-repos/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\Books-repos/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_generate_key'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsGenerateKeysCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\Books-repos/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\Books-repos/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_list'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsListCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\Books-repos/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\Books-repos/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_remove'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsRemoveCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\Books-repos/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\Books-repos/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_set'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsSetCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\Books-repos/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\Books-repos/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.translation_debug'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\TranslationDebugCommand(($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['translation.reader'] ?? $this->getTranslation_ReaderService()), ($this->privates['translation.extractor'] ?? $this->getTranslation_ExtractorService()), 'C:\\Books-repos/translations', 'C:\\Books-repos/templates', [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations'], [0 => 'C:\\Books-repos\\vendor\\symfony\\twig-bridge/Resources/views/Email', 1 => 'C:\\Books-repos\\vendor\\symfony\\twig-bridge/Resources/views/Form', 2 => 'C:\\Books-repos\\vendor\\symfony\\framework-bundle\\Command\\TranslationDebugCommand.php', 3 => 'C:\\Books-repos\\vendor\\symfony\\form\\Extension\\Core\\Type\\FileType.php', 4 => 'C:\\Books-repos\\vendor\\symfony\\form\\Extension\\Core\\Type\\TransformationFailureExtension.php', 5 => 'C:\\Books-repos\\vendor\\symfony\\form\\Extension\\Validator\\Type\\UploadValidatorExtension.php', 6 => 'C:\\Books-repos\\vendor\\symfony\\form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension.php', 7 => 'C:\\Books-repos\\vendor\\symfony\\validator\\Util\\LegacyTranslatorProxy.php', 8 => 'C:\\Books-repos\\vendor\\symfony\\framework-bundle\\CacheWarmer\\TranslationsCacheWarmer.php', 9 => 'C:\\Books-repos\\vendor\\symfony\\translation\\DataCollector\\TranslationDataCollector.php', 10 => 'C:\\Books-repos\\vendor\\symfony\\twig-bridge\\Extension\\TranslationExtension.php', 11 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle\\src\\Helper\\Processor.php']);
    ...
    protected function getConsole_Command_TranslationUpdateService()
    {
        ...
        $this->privates['console.command.translation_update'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\TranslationUpdateCommand($a, ($this->privates['translation.reader'] ?? $this->getTranslation_ReaderService()), ($this->privates['translation.extractor'] ?? $this->getTranslation_ExtractorService()), 'en', 'C:\\Books-repos/translations', 'C:\\Books-repos/templates', [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations'], [0 => 'C:\\Books-repos\\vendor\\symfony\\twig-bridge/Resources/views/Email', 1 => 'C:\\Books-repos\\vendor\\symfony\\twig-bridge/Resources/views/Form', 2 => 'C:\\Books-repos\\vendor\\symfony\\framework-bundle\\Command\\TranslationDebugCommand.php', 3 => 'C:\\Books-repos\\vendor\\symfony\\form\\Extension\\Core\\Type\\FileType.php', 4 => 'C:\\Books-repos\\vendor\\symfony\\form\\Extension\\Core\\Type\\TransformationFailureExtension.php', 5 => 'C:\\Books-repos\\vendor\\symfony\\form\\Extension\\Validator\\Type\\UploadValidatorExtension.php', 6 => 'C:\\Books-repos\\vendor\\symfony\\form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension.php', 7 => 'C:\\Books-repos\\vendor\\symfony\\validator\\Util\\LegacyTranslatorProxy.php', 8 => 'C:\\Books-repos\\vendor\\symfony\\framework-bundle\\CacheWarmer\\TranslationsCacheWarmer.php', 9 => 'C:\\Books-repos\\vendor\\symfony\\translation\\DataCollector\\TranslationDataCollector.php', 10 => 'C:\\Books-repos\\vendor\\symfony\\twig-bridge\\Extension\\TranslationExtension.php', 11 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle\\src\\Helper\\Processor.php']);
    ...
    protected function getContainer_EnvVarProcessorService()
    {
        return $this->privates['container.env_var_processor'] = new \Symfony\Component\DependencyInjection\EnvVarProcessor($this, new RewindableGenerator(function () {
            yield 0 => ($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\Books-repos/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET'))));
        }, 1));
    }
    ...
    {
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.KdFv2Aw'] ?? $this->get_ServiceLocator_KdFv2AwService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    {
        return $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), 'C:\\Books-repos', function () {
    ...
    protected function getDoctrine_Migrations_DependencyFactoryService()
    {
        ...
        $a->addMigrationsDirectory('DoctrineMigrations', 'C:\\Books-repos/migrations');
    ...
    protected function getErrorHandler_ErrorRenderer_HtmlService()
    {
        ...
        return $this->privates['error_handler.error_renderer.html'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\HtmlErrorRenderer(\Symfony\Component\ErrorHandler\ErrorRenderer\HtmlErrorRenderer::isDebug($a, true), 'UTF-8', ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()), 'C:\\Books-repos', \Symfony\Component\ErrorHandler\ErrorRenderer\HtmlErrorRenderer::getAndCleanOutputBuffer($a), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()));
    }
    ...
    {
        $this->privates['maker.auto_command.make_migration'] = $instance = new \Symfony\Bundle\MakerBundle\Command\MakerCommand(new \Symfony\Bundle\MakerBundle\Maker\MakeMigration('C:\\Books-repos'), ($this->privates['maker.file_manager'] ?? $this->getMaker_FileManagerService()), ($this->privates['maker.generator'] ?? $this->getMaker_GeneratorService()));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf'], 'ar' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.ar.xliff'], 'az' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.bg.xliff'], 'bs' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf'], 'ca' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf'], 'cs' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.cs.xliff'], 'cy' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf'], 'da' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.da.xliff'], 'de' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.de.xliff'], 'el' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.en.xliff'], 'es' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.es.xliff'], 'et' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf'], 'eu' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.eu.xliff'], 'fa' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.fa.xliff'], 'fi' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf'], 'fr' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.fr.xliff'], 'gl' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.hu.xliff'], 'hy' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf'], 'id' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.id.xliff'], 'it' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.it.xliff'], 'ja' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.ja.xliff'], 'lb' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.lt.xliff'], 'lv' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mn' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf'], 'nb' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.nl.xliff'], 'nn' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.no.xliff'], 'pl' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.pl.xliff'], 'pt' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf'], 'pt_BR' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.pt_BR.xliff'], 'ro' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.ro.xliff'], 'ru' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.ru.xliff'], 'sk' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf'], 'sl' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.sv.xliff'], 'th' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.tr.xliff'], 'uk' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf', 3 => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.uk.xliff'], 'vi' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => [0 => 'C:\\Books-repos\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 1 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 2 => 'C:\\Books-repos\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf'], 
\\Books-repos\\vendor\\symfony\\monolog-bundle/translations', 14 => 'C:\\Books-repos\\src/Resources/MonologBundle/translations', 15 => 'C:\\Books-repos\\vendor\\symfony\\debug-bundle/translations', 16 => 'C:\\Books-repos\\src/Resources/DebugBundle/translations', 17 => 'C:\\Books-repos\\vendor\\symfony\\maker-bundle\\src/translations', 18 => 'C:\\Books-repos\\src/Resources/MakerBundle/translations', 19 => 'C:\\Books-repos\\vendor\\doctrine\\doctrine-bundle/translations', 20 => 'C:\\Books-repos\\src/Resources/DoctrineBundle/translations', 21 => 'C:\\Books-repos\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 22 => 'C:\\Books-repos\\src/Resources/DoctrineMigrationsBundle/translations', 23 => 'C:\\Books-repos\\vendor\\symfony\\security-bundle/translations', 24 => 'C:\\Books-repos\\src/Resources/SecurityBundle/translations', 25 => 'C:\\Books-repos\\vendor\\twig\\extra-bundle\\src/translations', 26 => 'C:\\Books-repos\\src/Resources/TwigExtraBundle/translations', 27 => 'C:\\Books-repos\\vendor\\symfony\\web-server-bundle/translations', 28 => 'C:\\Books-repos\\src/Resources/WebServerBundle/translations', 29 => 'C:\\Books-repos\\src/Resources/KnpPaginatorBundle/translations', 30 => 'C:\\Books-repos\\src/Resources/translations']]]);
    ...
    {
        $this->privates['twig.command.debug'] = $instance = new \Symfony\Bridge\Twig\Command\DebugCommand(($this->services['twig'] ?? $this->getTwigService()), 'C:\\Books-repos', $this->parameters['kernel.bundles_metadata'], 'C:\\Books-repos/templates', ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()), 'C:\\Books-repos\\src');
    ...
    protected function getTwig_TemplateCacheWarmerService()
    {
        return $this->privates['twig.template_cache_warmer'] = new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'twig' => 'Twig\\Environment',
        ]))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(($this->services['kernel'] ?? $this->get('kernel', 1)), 'C:\\Books-repos\\src', ['C:\\Books-repos\\vendor\\symfony\\twig-bridge/Resources/views/Email' => 'email', 'C:\\Books-repos\\vendor\\symfony\\twig-bridge/Resources/views/Form' => NULL], 'C:\\Books-repos/templates'));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings([0 => 'C:\\Books-repos\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        $this->privates['web_server.command.server_run'] = $instance = new \Symfony\Bundle\WebServerBundle\Command\ServerRunCommand('C:\\Books-repos/public', 'dev', \dirname(__DIR__, 2));
    ...
    {
        $this->privates['web_server.command.server_start'] = $instance = new \Symfony\Bundle\WebServerBundle\Command\ServerStartCommand('C:\\Books-repos/public', 'dev', \dirname(__DIR__, 2));
    ...
    {
        return [
            'kernel.root_dir' => 'C:\\Books-repos\\src',
            'kernel.project_dir' => 'C:\\Books-repos',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'SensioFrameworkExtraBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\sensio\\framework-extra-bundle\\src',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'TwigExtraBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\twig\\extra-bundle\\src',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'WebServerBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\symfony\\web-server-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebServerBundle',
                ],
                'KnpPaginatorBundle' => [
                    'path' => 'C:\\Books-repos\\vendor\\knplabs\\knp-paginator-bundle',
            ...
            'translator.default_path' => 'C:\\Books-repos/translations',
            ...
            'twig.default_path' => 'C:\\Books-repos/templates',
