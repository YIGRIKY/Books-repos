...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'category_name'];
        }
     ...
     * {@inheritDoc}
     */
    public function getCategoriesAndBooks(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCategoriesAndBooks', []);

        return parent::getCategoriesAndBooks();
    }

    /**
     * {@inheritDoc}
     */
    public function addCategoriesAndBook(\App\Entity\CategoriesAndBooks $categoriesAndBook): \App\Entity\Category
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCategoriesAndBook', [$categoriesAndBook]);

        return parent::addCategoriesAndBook($categoriesAndBook);
    }

    /**
     * {@inheritDoc}
     */
    public function removeCategoriesAndBook(\App\Entity\CategoriesAndBooks $categoriesAndBook): \App\Entity\Category
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCategoriesAndBook', [$categoriesAndBook]);
